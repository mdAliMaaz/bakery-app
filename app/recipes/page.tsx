...
export default function RecipesPage() {
  ...
  >([]);
  const [recipeNameSuggestions, setRecipeNameSuggestions] = useState<
    ...
    <ProtectedRoute allowedRoles={["Admin", "Staff", "Viewer"]}>
      <AppLayout>
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
            <div>
              ...
              <p className="text-gray-400 font-medium">
                Create and manage recipes for your bakery items
              </p>
            </div>
            <PremiumButton
              onClick={() => {
        ...
        {!loading && recipePerformance.length > 0 && (
          <div className="mb-8">
            <RecipeSalesCharts recipePerformance={recipePerformance} />
          </div>
        )}
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {recipes.map((recipe) => (
              <div
                key={recipe._id}
                className="bg-card border border-border p-6 shadow-md hover:shadow-lg transition-all duration-300 transform hover:scale-105"
              >
                ...
                <div className="mb-4">
                  <p className="text-sm text-gray-100 font-medium">
                    <span className="font-semibold">Standard Yield:</span>{" "}
                    {recipe.standardQuantity} {recipe.standardUnit}
                  </p>
                </div>
                <div className="mb-4">
        ...
        >
          <form
            ...
            className="space-y-4 max-h-[70vh] overflow-visible pr-2"
          >
            {submitError && (
            ...
            <Autocomplete
              ...
              onSelect={(option) =>
                setFormData({ ...formData, name: option.label })
              }
            ...
            <div className="grid grid-cols-2 gap-4">
              <PremiumInput
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    standardQuantity: parseInt(e.target.value),
                  })
                }
              />
              <PremiumInput
                ...
                onChange={(e) =>
                  setFormData({ ...formData, standardUnit: e.target.value })
                }
              />
            </div>
                ...
                <div key={index} className="flex gap-3 mb-3 items-end">
                  <div className="flex-1 min-w-0">
                    <Autocomplete
                      ...
                      value={
                        inventoryItems.find(
                          (item) => item.value === ingredient.inventoryItem,
                        )?.label || ""
                      }
                      onChange={(value) => {
                      ...
                      placeholder={
                        inventoryItems.length === 0
                          ? "No inventory items available (showing test data)"
