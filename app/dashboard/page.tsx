...
export default function DashboardPage() {
  ...
  const [activeTab, setActiveTab] = useState<
    "overview" | "inventory" | "orders" | "recipes"
  >("overview");
      ...
      eventSource.onmessage = (event) => {
        try {
          ...
          if (
            ...
            data.type === "low-stock-alert" ||
            data.type === "order-update"
          ) {
            fetchStats();
          }
        } catch (error) {
      ...
      <AppLayout>
        ...
        <div className="mb-8 relative floating-particles">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-8">
            <div
              className="colorful-card p-6 md:p-8 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 animate-fade-in"
            ...
            >
              ...
              <p className="text-4xl md:text-5xl font-bold cyberpunk-text-secondary animate-count-up">
            ...
            >
              ...
              <p className="text-4xl md:text-5xl font-bold text-red-400 animate-count-up">
            ...
            >
              ...
              <p className="text-4xl md:text-5xl font-bold cyberpunk-text-primary animate-count-up">
                {stats.orders.total}
              </p>
            ...
            >
              <div className="flex items-center justify-between mb-2">
                <h3 className="text-sm font-semibold text-green-400 uppercase tracking-wider mb-1">
                  Completed ({period})
                </h3>
                <CheckCircle2 className="w-6 h-6 text-green-400 animate-pulse" />
              </div>
              <p className="text-4xl md:text-5xl font-bold text-green-400 animate-count-up">
                {stats.orders.completedInPeriod}
              </p>
        ...
        <div className="animate-fade-in">
                ...
                <div className="bg-gradient-to-r from-red-900/20 to-red-800/20 border border-red-800 p-8 mb-8 shadow-xl">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {stats.inventory.lowStockItems.map((item, idx) => (
                      <div
                        key={idx}
                        className="bg-card p-4 rounded-xl border border-red-800 shadow-md"
                      >
                        <p className="font-semibold text-gray-100">
                          {item.name}
                        </p>
                        <p className="text-sm text-gray-300 font-medium">
                          Current: {item.currentStock} {item.unit} | Threshold:{" "}
          ...
          {activeTab === "recipes" && stats && (
            <RecipeSalesCharts recipePerformance={stats.recipes?.performance} />
          )}
        </div>
      </AppLayout>
    </ProtectedRoute>
