...
import { AlertTriangle, Plus, Search, Package, TrendingUp, TrendingDown } from 'lucide-react';
...
export default function FinishedGoodsPage() {
    ...
    const [recipes, setRecipes] = useState<Array<{ value: string; label: string; data: any }>>([]);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setSubmitError(error.response?.data?.error || 'Failed to create finished goods item');
        }
    };
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (item: FinishedGoodsItem) => {
                ...
                return (
                    <div className="flex items-center">
                        <span className={`font-bold text-lg ${isLowStock ? 'text-red-400' : 'text-green-400'}`}>
                            {item.currentStock}
                        </span>
        ...
        },
        {
            ...
            render: (item: FinishedGoodsItem) => (
                <span className="text-gray-300 font-medium">
                    {item.lastProducedDate ? new Date(item.lastProducedDate).toLocaleDateString() : 'Never'}
                </span>
            ),
        },
    ];
                ...
                <div className="space-y-8">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                        <div className="relative floating-particles">
                            ...
                            <p className="text-gray-400 font-medium animate-fade-in" style={{ animationDelay: '0.1s' }}>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mb-8">
                        <div className="colorful-card p-6 hover:shadow-2xl transition-all duration-300 hover:scale-105 animate-fade-in animate-glow" style={{ animationDelay: '0.1s' }}>
                            ...
                            <p className="text-3xl md:text-4xl font-bold cyberpunk-text-secondary animate-count-up">{items.length}</p>
                            <p className="text-xs text-gray-400 mt-2">Active products</p>
                        </div>

                        <div className="colorful-card p-6 hover:shadow-2xl transition-all duration-300 hover:scale-105 animate-fade-in" style={{ animationDelay: '0.2s' }}>
                            <div className="flex items-center justify-between mb-2">
                                <h3 className="text-sm font-semibold text-red-400 uppercase tracking-wider">Low Stock Items</h3>
                        ...
                        <div className="colorful-card p-6 hover:shadow-2xl transition-all duration-300 hover:scale-105 animate-fade-in" style={{ animationDelay: '0.3s' }}>
                            <div className="flex items-center justify-between mb-2">
                                <h3 className="text-sm font-semibold text-green-400 uppercase tracking-wider">Total Stock</h3>
